 ...
 */
enum class IppOperations(value: Int) {
    ...
    override fun toString(): String {
        val s = super.toString().toLowerCase().replace("_".toRegex(), " ")
        return WordUtils.capitalize(s).replace(" ".toRegex(), "-")
    }
    ...
    companion object {
        ...
        fun of(id: Int): IppOperations {
            ...
            throw IllegalArgumentException("invalid id: 0x" + Integer.toHexString(id))
        }
    }
