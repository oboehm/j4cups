...
/**
 * Unit tests for {@link AttributeWithOneValue}. The DATA for this tests are
 * recorded during an installation of a printer in CUPS, where the header of
 * the IPP request (the first 9 bytes) were removed.
 */
public final class AttributeWithOneValueTest {

    private static final byte[] DATA =
            {71, 0, 18, 97, 116, 116, 114, 105, 98, 117, 116, 101, 115, 45, 99, 104, 97, 114, 115, 101, 116, 0, 5, 117,
                    116, 102, 45, 56, 72, 0};
    private static final AttributeWithOneValue ATTRIBUTE = new AttributeWithOneValue(ByteBuffer.wrap(DATA));
